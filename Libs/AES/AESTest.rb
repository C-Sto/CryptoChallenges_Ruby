...
puts "d4bf5d30e0b452aeb84111f11e2798e5 verify shiftRows operation"
puts
state = mixColumns(state)

puts state.to_s(16)
puts "46681e5e0cb199a48f8d37a2806264c verify mixcolumns operation"
puts

state = addRoundKey(state,key[1])
puts state.to_s(16)
puts "a49c7ff2689f352b6b5bea43026a5049 verify round key final"
#final round (no mix)
